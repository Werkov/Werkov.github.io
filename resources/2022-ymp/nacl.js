...
function crypto_scalarmult(q, n, p) {
  ...
  for (i=254; i>=0; --i) {
    r=(z[i>>>3]>>>(i&7))&1;
	  // mk: below is expanded summation and doubling
    sel25519(a,b,r);
    sel25519(c,d,r);
    A(e,a,c);
    Z(a,a,c);
...
nacl.lowlevel = {
  ...
  // see https://github.com/dchest/tweetnacl-js/pull/218 (it was not merged in the end)
  // https://github.com/dchest/tweetnacl-js/issues/14
  unpackneg: unpackneg,
  pack: pack,
};
